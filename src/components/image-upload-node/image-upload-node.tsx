...
export const ImageUploadNode: React.FC<NodeViewProps> = (props) => {
  ...
  // Remove node if editor is not editable and no files have been uploaded
  useEffect(() => {
    if (!props.editor.isEditable && fileItems.length === 0) {
  ...
  }, [props.editor.isEditable, fileItems.length, props]);
